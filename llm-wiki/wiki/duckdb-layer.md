...
modified: 2026-07-30
status: verified
sources: [raw/2026-07-17-duckdb-layer-design.md, raw/2026-07-30-process-aware-objects.md]
...
- **Tables:** `gl_lines` ([[general-ledger-sheet]] columns 1:1) + `accounts` ([[chart-of-accounts]] sheet) + `rec_clears` (the `Reconciliations` sheet, [[sheets-layer]]) — all on the one version key **(proposed 2026-07-30)**.
